...
## 15 September 2019
This update adds raw to all poly statements, tries adding an interaction term for snow and precip, and constructs heat maps for visualizing the Hutchinsonian niche.
...
For this model, we will try an interaction between the linear components of snow cover and rain
...
Since the interaction term doesn't add anything, we will not include it and stick with the simple reduced model.
...
hutchinson_df <- expand.grid(snow=snow_vec,precip=precip_vec)
